 ...
 *
 */
public class AzerAgentSplitsOnly extends Agent
{
        ...
        boolean sensorNext = true;
		 ...
		 updateAllTrees(prefixRoot);
            ...
            for (int i = 0; i < prefixChildren.length; i++) {
                ...
                if (oldBestNode.suffix.equals(potentialNewBestNode.suffix)){
                    proceed = false;
                }
	    }
	    if (proceed){
        ...
        try
        {
            ...
            for (int i = 1; i <= NUM_MACHINES; ++i)
            {
                ...
                System.out.println("Starting on Machine " + i + " of "
                        + NUM_MACHINES);
                AzerAgentSplitsOnly gilligan = new AzerAgentSplitsOnly();
